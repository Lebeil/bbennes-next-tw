            ...
            <div className="p-5 text-left">
                ...
                <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie
                    numérique, il est précisé aux utilisateurs du site <a
                        href="http://www.b-bennes.fr/">www.b-bennes.fr</a> l'identité des différents intervenants dans le
                    cadre de sa réalisation et de son suivi :</p>
                <p><strong>Propriétaire</strong> : B-bennes – SARL 449 148 758 – 63 Avenue Aristide Briand 93190
                    Livry-Gargan<br/>
                    <strong>Créateur</strong> : <a href="www.liedel.fr">Liedel LAM</a><br/>
                    <strong>Responsable publication</strong> : BENASSAID Mohamed – b.bennelocation@gmail.com<br/>
                    Le responsable publication est une personne physique ou une personne morale.<br/>
                    <strong>Webmaster</strong> : Liedel LAM – liedell@orange.fr<br/>
                    <strong>Hébergeur</strong> : Firebase – Google LLC 1600 Amphitheatre Pkwy Mountain View, CA, 94043,
                    États-Unis<br/><br/>
                </p>

                <h3 className="p-2 text-2xl bg-primaryColor md:w-max w-auto text-white">2. Conditions générales d’utilisation du site
                    et des services proposés.</h3>
                <p className="mt-5">L’utilisation du site <a href="http://www.b-bennes.fr/">www.b-bennes.fr</a> implique l’acceptation pleine
                    ...
                    susceptibles d’être modifiées ou complétées à tout moment, les utilisateurs du site <a
                        href="http://www.b-bennes.fr/">www.b-bennes.fr</a> sont donc invités à les consulter de manière
                    régulière.</p>
                <p>Ce site est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de
                    maintenance technique peut être toutefois décidée par B-bennes, qui s’efforcera alors de communiquer
                    préalablement aux utilisateurs les dates et heures de l’intervention.</p>
                <p>Le site <a href="http://www.b-bennes.fr/">www.b-bennes.fr</a> est mis à jour régulièrement par BENASSAID
                    Mohamed. De la même façon, les mentions légales peuvent être modifiées à tout moment : elles s’imposent
                    néanmoins à l’utilisateur qui est invité à s’y référer le plus souvent possible afin d’en prendre
                    connaissance.</p>
                <h3>3. Description des services fournis.</h3>
                <p>Le site <a href="http://www.b-bennes.fr/">www.b-bennes.fr</a> a pour objet de fournir une information
                    concernant l’ensemble des activités de la société.</p>
                <p>B-bennes s’efforce de fournir sur le site <a href="http://www.b-bennes.fr/">www.b-bennes.fr</a> des
                    informations aussi précises que possible. Toutefois, il ne pourra être tenu responsable des omissions,
                    des inexactitudes et des carences dans la mise à jour, qu’elles soient de son fait ou du fait des tiers
                    partenaires qui lui fournissent ces informations.</p>
                <p>Tous les informations indiquées sur le site <a href="http://www.b-bennes.fr/">www.b-bennes.fr</a> sont
                    données à titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur
                    le site <a href="http://www.b-bennes.fr/">www.b-bennes.fr</a> ne sont pas exhaustifs. Ils sont donnés
                ...
                <p>B-bennes est propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur tous
                ...
                <p>B-bennes ne pourra être tenue responsable des dommages directs et indirects causés au matériel de
                    l’utilisateur, lors de l’accès au site www.b-bennes.fr, et résultant soit de l’utilisation d’un matériel
                    ne répondant pas aux spécifications indiquées au point 4, soit de l’apparition d’un bug ou d’une
                    incompatibilité.</p>
                <p>B-bennes ne pourra également être tenue responsable des dommages indirects (tels par exemple qu’une perte
                    de marché ou perte d’une chance) consécutifs à l’utilisation du site <a
                        href="http://www.b-bennes.fr/">www.b-bennes.fr</a>.</p>
                <p className="mb-5">Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition
                    des utilisateurs. B-bennes se réserve le droit de supprimer, sans mise en demeure préalable, tout
                    contenu déposé dans cet espace qui contreviendrait à la législation applicable en France, en particulier
                    aux dispositions relatives à la protection des données. Le cas échéant, B-bennes se réserve également la
                ...
                <h3 id="#cookies" className="bg-secondaryColor mb-5 p-2 md:w-max text-white mx-auto font-bold text-2xl">7. Gestion des données personnelles.</h3>
                <p>En France, les données personnelles sont notamment protégées par la loi n° 78-87 du 6 janvier 1978, la
                    ...
                    octobre 1995.</p>
                <p>A l'occasion de l'utilisation du site <a href="http://www.b-bennes.fr/">www.b-bennes.fr</a>, peuvent
                    êtres recueillies : l'URL des liens par l'intermédiaire desquels l'utilisateur a accédé au site <a
                        href="http://www.b-bennes.fr/">www.b-bennes.fr</a>, le fournisseur d'accès de l'utilisateur,
                    l'adresse de protocole Internet (IP) de l'utilisateur.</p>
                <p> En tout état de cause B-bennes ne collecte des informations personnelles relatives à l'utilisateur que
                    pour le besoin de certains services proposés par le site <a
                        href="http://www.b-bennes.fr/">www.b-bennes.fr</a>. L'utilisateur fournit ces informations en toute
                    connaissance de cause, notamment lorsqu'il procède par lui-même à leur saisie. Il est alors précisé à
                    l'utilisateur du site <a href="http://www.b-bennes.fr/">www.b-bennes.fr</a> l’obligation ou non de
                ...
                <p>Aucune information personnelle de l'utilisateur du site <a
                    href="http://www.b-bennes.fr/">www.b-bennes.fr</a> n'est publiée à l'insu de l'utilisateur, échangée,
                    transférée, cédée ou vendue sur un support quelconque à des tiers. Seule l'hypothèse du rachat de
                    B-bennes et de ses droits permettrait la transmission des dites informations à l'éventuel acquéreur qui
                    serait à son tour tenu de la même obligation de conservation et de modification des données vis à vis de
                    l'utilisateur du site <a href="http://www.b-bennes.fr/">www.b-bennes.fr</a>.</p>
                ...
                <p>Le site <a href="http://www.b-bennes.fr/">www.b-bennes.fr</a> contient un certain nombre de liens
                    hypertextes vers d’autres sites, mis en place avec l’autorisation de B-bennes. Cependant, B-bennes n’a
                ...
                <p>La navigation sur le site <a href="http://www.b-bennes.fr/">www.b-bennes.fr</a> est susceptible de
                ...
                <p>Tout litige en relation avec l’utilisation du site <a
                    href="http://www.b-bennes.fr/">www.b-bennes.fr</a> est soumis au droit français. Il est fait attribution
                    exclusive de juridiction aux tribunaux compétents de Paris.</p>
                ...
                <p className="mb-10">Informations personnelles : « les informations qui permettent, sous quelque forme que ce soit,
