...
const Contact = () => {
            ...
            <section id="contact" className="bg-gray-50 pb-40 pt-28">
                ...
                <hr className="bloc mx-auto bg-gray-600 h-1 mb-10 w-44"/>
                    ...
                    <form
                        ...
                        <div className="mb-2 px-2 mx-auto text-white bg-secondaryColor w-max">Devis gratuit et sans engagement</div>
    ...
    />
                        ...
                        <div>
                            <button
                                className="inline-flex justify-center items-center w-full mt-10 py-3 px-6 border-transparent shadow-sm text-base font-medium rounded-md text-white bg-blue-700">
                                Envoyer
                            </button>
                        </div>
